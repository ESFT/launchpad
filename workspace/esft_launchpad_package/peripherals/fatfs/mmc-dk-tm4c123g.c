...
set_max_speed(void) {
  ...
  MAP_SSIConfigSetExpClk(SDC_SSI_BASE, MAP_SysCtlClockGet(), SSI_FRF_MOTO_MODE_0, SSI_MODE_MASTER, i, 8);
...
static
int
chk_power(void) /* Socket power state: 0=off, 1=on */
{
  return PowerFlag;
}
...
static
bool
rcvr_datablock(BYTE *buff, /* Data buffer to store received data */
...
static
bool
xmit_datablock(const BYTE *buff, /* 512 byte data block to be transmitted */
...
static BYTE
send_cmd(BYTE cmd, /* Command byte */
DWORD arg /* Argument */
) {
  BYTE n, res;
